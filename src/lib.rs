...
//! # OptionStratLib v0.15.0: Financial Options Library
//!
//! ## Table of Contents
...
//! ```toml
//! [dependencies]
//! optionstratlib = { version = "0.15.0", features = ["plotly"] }
//! ```
//!
...
//! ---
//!
//! **OptionStratLib v0.15.0** - Built with ❤️ in Rust for the financial community
//!
